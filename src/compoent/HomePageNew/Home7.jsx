...
//   }
//   .instant-book-btn .bolt-icon {
//     font-size: 12px;
//     line-height: 1;
//   }

//   /* ── Small ghost variant for playlist sidebar ── */
...
//                       <a
//                         className="instant-book-btn-ghost"
//                         href={v.bookingUrl}
//                         onClick={(e) => e.stopPropagation()}
//                       >
//                         ⚡ Instant Booking
...
//                       <div className="watch-btn" onClick={(e) => { e.stopPropagation(); openModal(v); }}>
//                         Watch
//                       </div>
//                       <a
//                         className="instant-book-btn"
//                         href={v.bookingUrl}
//                         onClick={(e) => e.stopPropagation()}
//                         style={{ fontSize: "9px", padding: "9px 16px" }}
//                       >
//                         <span className="bolt-icon">⚡</span>
//                         Instant Booking
//                       </a>
...
//                       href={v.bookingUrl}
//                       onClick={(e) => e.stopPropagation()}
//                       style={{ fontSize: "8px", padding: "7px 12px", letterSpacing: "1.5px" }}
//                     >
//                       ⚡ Instant Booking
//                     </a>
//                   </div>

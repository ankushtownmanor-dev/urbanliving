    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Book a Stay Button - FULL TEXT ON MOBILE */}
          <div className="navbar-book-stay">
            ...
            >
              <span style={{ fontSize: isMobile ? 13 : 16 }}>🏖️</span>
              <span>Book a Stay</span>
            </button>
          </div>
          ...
          {/* Become a Host Button - FULL TEXT ON MOBILE */}
        ...
        {/* Hamburger Menu Panel (Desktop Only) */}
        {hamburgerMenuOpen && (
          <>
            <div

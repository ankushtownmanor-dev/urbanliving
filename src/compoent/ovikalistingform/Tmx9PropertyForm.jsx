...
// const STORAGE_KEY = "user"; // change if your AuthContext uses a different key
...
// // ---------- file validation helpers (including AVIF) ----------
...
//   // Allow browser-provided image/* (png/jpg/webp/avif etc.)
...
//         try { localStorage.setItem(STORAGE_KEY, JSON.stringify(maybe)); } catch (e) { /* ignore */ }
//         return maybe;
//       }
//     } catch (err) {
...
//       setForm((prev) => ({ ...prev, title: "", mainDescription: "", address: "", city: "", postalCode: "", baseRate: "" }));
//       photoPreviews.clear();
//       setIdFiles([]);
//       setSelfieFile(null);
//       setCoverIndex(null);
...
//   const renderError = (field) => (errors[field] ? <span style={{ color: "#dc2626", fontSize: "0.875rem", marginTop: "4px", display: "block" }}>{errors[field]}</span> : null);
...
//   const Toggle = ({ name, value, onChange }) => (
//     <div style={{ display: "flex", gap: "8px", border: "1px solid #e2e8f0", borderRadius: "8px", padding: "4px", background: "#f8fafc" }} role="group" aria-label={name}>
//       <button 
//         type="button" 
//         style={{
//           flex: 1,
...
//           border: "none",
//           borderRadius: "6px",
//           background: value === false ? "#3b82f6" : "transparent",
//           color: value === false ? "white" : "#64748b",
//           cursor: "pointer",
//           fontSize: "14px",
//           fontWeight: "500",
//           display: "flex",
...
//       paddingBottom: "8px"
//     },
//     stepItem: (isActive, isDone) => ({
//       display: "flex",
//       alignItems: "center",
//       gap: "8px",
//       padding: "8px 16px",
//       borderRadius: "8px",
//       background: isActive ? "#3b82f6" : isDone ? "#10b981" : "#f1f5f9",
...
//   return (
//     <form style={styles.root} onSubmit={handleSubmit} noValidate>
//       <header style={styles.header}>
//         <h1 style={styles.title}>Create <span style={{ color: "#3b82f6" }}>Property</span> Listing</h1>
//         <p style={styles.sub}>Fill the sections below carefully. Use Next / Previous to navigate steps.</p>

//         <div style={styles.stepper}>
//           {STEPS.map((s, i) => (
//             <div key={s.id} style={styles.stepItem(i === step, i < step)}>
//               <div>{i + 1}</div>
//               <div>{s.title}</div>
//             </div>
//           ))}
...
//         {step === 0 && (
//           <section>
//             <h2 style={styles.sectionTitle}>Basic Property Information & Description</h2>
//             <div style={styles.grid}>
//               <div style={styles.field}>
//                 <label style={styles.label}>Property Type</label>
//                 <select name="propertyType" value={form.propertyType} onChange={handleChange} style={styles.select}>
//                   {PROPERTY_TYPES.map((p) => <option key={p} value={p}>{p}</option>)}
//                 </select>
//               </div>
...
//                 <select name="propertyCategory" value={form.propertyCategory} onChange={handleChange} style={styles.select}>
//                   {DEFAULT_PROPERTY_CATEGORIES.map((c) => <option key={c} value={c}>{c}</option>)}
//                 </select>
//               </div>
...
//                   onChange={handleChange} 
//                   rows="4" 
//                   style={{ ...styles.textarea, ...(errors.mainDescription && styles.inputError) }} 
//                 />
//                 {renderError("mainDescription")}
//               </div>
...
//             <div style={{ marginTop: "32px", paddingTop: "32px", borderTop: "2px solid #f1f5f9" }}>
//               <h3 style={{ fontSize: "18px", fontWeight: "600", color: "#1e293b", marginBottom: "16px" }}>
//                 🚗 Transport & Travel Tips
//               </h3>
//               <div style={styles.grid}>
//                 <div style={styles.field}>
//                   <label style={styles.label}>Taxi Services</label>
//                   <input
//                     value={form.transportTips.taxi}
//                     onChange={(e) => setForm(f => ({ ...f, transportTips: { ...f.transportTips, taxi: e.target.value } }))}
//                     style={styles.input}
//                     placeholder="e.g., Uber/Ola available"
//                   />
//                 </div>
//                 <div style={styles.field}>
//                   <label style={styles.label}>Parking Info</label>
//                   <input
//                     value={form.transportTips.parking}
//                     onChange={(e) => setForm(f => ({ ...f, transportTips: { ...f.transportTips, parking: e.target.value } }))}
//                     style={styles.input}
//                     placeholder="e.g., Free street parking"
//                   />
//                 </div>
//                 <div style={{ ...styles.field, gridColumn: "1 / -1" }}>
//                   <label style={styles.label}>Local Travel Tips</label>
//                   <input
//                     value={form.transportTips.localTravel}
//                     onChange={(e) => setForm(f => ({ ...f, transportTips: { ...f.transportTips, localTravel: e.target.value } }))}
//                     style={styles.input}
//                     placeholder="e.g., Auto easily available"
//                   />
//                 </div>
//               </div>
//             </div>
...
//             <div style={{ marginTop: "32px", paddingTop: "32px", borderTop: "2px solid #f1f5f9" }}>
//               <h3 style={{ fontSize: "18px", fontWeight: "600", color: "#1e293b", marginBottom: "16px" }}>
//                 🍽️ Nearby Cafes & Restaurants
//               </h3>
//               {form.cafesRestaurants.map((cafe, index) => (
//                 <div key={cafe.id} style={styles.dynamicRow}>
//                   <input
//                     placeholder="Restaurant Name"
//                     value={cafe.name}
//                     onChange={(e) => {
//                       const newCafes = [...form.cafesRestaurants];
//                       newCafes[index].name = e.target.value;
//                       setForm(f => ({ ...f, cafesRestaurants: newCafes }));
//                     }}
...
//                     value={cafe.distanceM}
//                     onChange={(e) => {
//                       const newCafes = [...form.cafesRestaurants];
//                       newCafes[index].distanceM = e.target.value;
//                       setForm(f => ({ ...f, cafesRestaurants: newCafes }));
//                     }}
...
//                       type="button"
//                       onClick={() => {
//                         const newCafes = form.cafesRestaurants.filter((_, i) => i !== index);
//                         setForm(f => ({ ...f, cafesRestaurants: newCafes }));
//                       }}
...
//               <button
//                 type="button"
//                 onClick={() => setForm(f => ({ ...f, cafesRestaurants: [...f.cafesRestaurants, { id: Date.now(), name: "", distanceM: "" }] }))}
//                 style={{ ...styles.smallBtn, marginTop: "8px" }}
//               >
//                 + Add Restaurant
//               </button>
//             </div>
...
//                   <input
//                     value={form.essentialsNearby.atm}
//                     onChange={(e) => setForm(f => ({ ...f, essentialsNearby: { ...f.essentialsNearby, atm: e.target.value } }))}
//                     style={styles.input}
//                     placeholder="e.g., HDFC ATM"
//                   />
//                 </div>
//                 <div style={styles.field}>
//                   <label style={styles.label}>Grocery Store</label>
//                   <input
//                     value={form.essentialsNearby.grocery}
//                     onChange={(e) => setForm(f => ({ ...f, essentialsNearby: { ...f.essentialsNearby, grocery: e.target.value } }))}
//                     style={styles.input}
//                     placeholder="e.g., Reliance Fresh (200m)"
//                   />
//                 </div>
//                 <div style={styles.field}>
//                   <label style={styles.label}>Medical/Pharmacy</label>
//                   <input
//                     value={form.essentialsNearby.medical}
//                     onChange={(e) => setForm(f => ({ ...f, essentialsNearby: { ...f.essentialsNearby, medical: e.target.value } }))}
//                     style={styles.input}
//                     placeholder="e.g., Apollo Pharmacy (300m)"
//                   />
//                 </div>
//               </div>
//             </div>
...
//         {step === 1 && (
//           <section>
//             <h2 style={styles.sectionTitle}>Property Details & Features</h2>
//             <div style={styles.grid}>
//               <div style={{ ...styles.field, gridColumn: "1 / -1" }}>
//                 <label style={styles.label}>Bedroom Configuration *</label>
//                 {form.bedroomDetails.map((item, index) => (
//                   <div key={item.id} style={styles.dynamicRow}>
//                     <select
//                       value={item.type}
//                       onChange={(e) => {
//                         const newDetails = [...form.bedroomDetails];
...
//               <div style={{ ...styles.field, gridColumn: "1 / -1" }}>
//                 <label style={styles.label}>Bathroom Configuration *</label>
//                 {form.bathroomDetails.map((item, index) => (
//                   <div key={item.id} style={styles.dynamicRow}>
//                     <select
//                       value={item.type}
...
//               <div style={{ ...styles.field, gridColumn: "1 / -1" }}>
//                 <label style={styles.label}>Amenities (select all that apply)</label>
//                 {Object.entries(AMENITIES).map(([group, list]) => (
//                   <div key={group} style={{ marginBottom: "16px" }}>
//                     <div style={{ fontWeight: "600", marginBottom: "8px", color: "#334155" }}>{group}</div>
...
//               <div style={styles.field}>
//                 <label style={styles.label}>Smoking Allowed</label>
//                 <Toggle 
//                   name="smokingAllowed" 
//                   value={form.smokingAllowed} 
//                   onChange={(v) => setForm((s) => ({ ...s, smokingAllowed: v }))} 
//                 />
//               </div>

//               <div style={styles.field}>
//                 <label style={styles.label}>Pets Allowed</label>
//                 <Toggle 
//                   name="petsAllowed" 
//                   value={form.petsAllowed} 
//                   onChange={(v) => setForm((s) => ({ ...s, petsAllowed: v }))} 
//                 />
//               </div>

//               <div style={styles.field}>
//                 <label style={styles.label}>Events / Parties Allowed</label>
//                 <Toggle 
//                   name="eventsAllowed" 
//                   value={form.eventsAllowed} 
//                   onChange={(v) => setForm((s) => ({ ...s, eventsAllowed: v }))} 
//                 />
//               </div>

//               <div style={styles.field}>
//                 <label style={styles.label}>Drinking Alcohol Allowed</label>
//                 <Toggle 
//                   name="drinkingAllowed" 
//                   value={form.drinkingAllowed} 
//                   onChange={(v) => setForm((s) => ({ ...s, drinkingAllowed: v }))} 
//                 />
//               </div>

//               <div style={styles.field}>
//                 <label style={styles.label}>Outside Guests Allowed</label>
//                 <Toggle 
//                   name="outsideGuestsAllowed" 
//                   value={form.outsideGuestsAllowed} 
//                   onChange={(v) => setForm((s) => ({ ...s, outsideGuestsAllowed: v }))} 
//                 />
//               </div>

//               <div style={styles.field}>
//                 <label style={styles.label}>Quiet Hours</label>
//                 <input 
//                   name="quietHours" 
...
//                 <div key={place.id} style={styles.dynamicRow}>
//                   <input
//                     placeholder="Place Name"
//                     value={place.place}
//                     onChange={(e) => {
//                       const newPlaces = [...form.mustVisitPlaces];
//                       newPlaces[index].place = e.target.value;
//                       setForm(f => ({ ...f, mustVisitPlaces: newPlaces }));
//                     }}
//                     style={{ ...styles.input, flex: 2 }}
//                   />
//                   <input
...
//                     onChange={(e) => {
//                       const newPlaces = [...form.mustVisitPlaces];
//                       newPlaces[index].bestTime = e.target.value;
//                       setForm(f => ({ ...f, mustVisitPlaces: newPlaces }));
//                     }}
//                     style={{ ...styles.input, flex: 1 }}
//                   />
...
//                       type="button"
//                       onClick={() => {
//                         const newPlaces = form.mustVisitPlaces.filter((_, i) => i !== index);
//                         setForm(f => ({ ...f, mustVisitPlaces: newPlaces }));
//                       }}
//                       style={{ ...styles.smallBtn, ...styles.dangerBtn }}
//                     >
...
//               <button
//                 type="button"
//                 onClick={() => setForm(f => ({ ...f, mustVisitPlaces: [...f.mustVisitPlaces, { id: Date.now(), place: "", bestTime: "" }] }))}
//                 style={{ ...styles.smallBtn, marginTop: "8px" }}
//               >
//                 + Add Place
//               </button>
...
//                   <input
//                     placeholder="Add a helpful tip for guests"
//                     value={tip}
//                     onChange={(e) => {
//                       const newTips = [...form.houseSpecificTips];
//                       newTips[index] = e.target.value;
//                       setForm(f => ({ ...f, houseSpecificTips: newTips }));
//                     }}
//                     style={{ ...styles.input, flex: 1 }}
//                   />
...
//                       type="button"
//                       onClick={() => {
//                         const newTips = form.houseSpecificTips.filter((_, i) => i !== index);
//                         setForm(f => ({ ...f, houseSpecificTips: newTips }));
//                       }}
//                       style={{ ...styles.smallBtn, ...styles.dangerBtn }}
//                     >
...
//               <button
//                 type="button"
//                 onClick={() => setForm(f => ({ ...f, houseSpecificTips: [...f.houseSpecificTips, ""] }))}
//                 style={{ ...styles.smallBtn, marginTop: "8px" }}
//               >
//                 + Add Tip
//               </button>
...
//         {step === 3 && (
//           <section>
//             <h2 style={styles.sectionTitle}>Photos & Media</h2>
//             <div style={styles.field}>
//               <label style={styles.label}>Photos (drag & select) — up to 12 *</label>
//               <input 
//                 type="file" 
...
//                 {photoPreviews.previews.length === 0 && (
//                   <div style={{ color: "#94a3b8", fontSize: "14px" }}>No photos selected</div>
//                 )}
//                 {photoPreviews.previews.map((p, i) => (
//                   <div 
//                     key={i} 
...
//                       borderRadius: "8px", 
//                       overflow: "hidden",
//                       border: coverIndex === i ? "3px solid #3b82f6" : "1px solid #e2e8f0"
//                     }}
//                   >
//                     <img 
//                       src={p.url} 
...
//                           fontSize: "11px", 
//                           padding: "4px 8px",
//                           background: coverIndex === i ? "#3b82f6" : "white",
//                           color: coverIndex === i ? "white" : "#334155"
//                         }}
//                       >
//                         Cover
//                       </button>
...
//             <div style={styles.grid}>
//               <div style={styles.field}>
//                 <label style={styles.label}>Base nightly rate (Rs) *</label>
//                 <input 
//                   name="baseRate" 
//                   type="number" 
//                   min="0" 
...
//               <div style={styles.field}>
//                 <label style={styles.label}>Weekend rate</label>
//                 <input 
//                   type="number" 
//                   name="weekendRate" 
...
//                   onChange={handleNumChange} 
//                   style={{ ...styles.input, ...(errors.weeklyDiscountPct && styles.inputError) }} 
//                 />
//                 {renderError("weeklyDiscountPct")}
//               </div>

//               <div style={styles.field}>
//                 <label style={styles.label}>Monthly discount (%)</label>
//                 <input 
//                   step="0.01" 
...
//               <div style={styles.field}>
//                 <label style={styles.label}>Self-check-in *</label>
//                 <select 
//                   name="selfCheckIn" 
//                   value={form.selfCheckIn} 
//                   onChange={handleChange} 
//                   style={{ ...styles.select, ...(errors.selfCheckIn && styles.inputError) }}
//                 >
//                   <option value="">Select option</option>
//                   <option value="Available">Available</option>
//                   <option value="Not Available">Not Available</option>
...
//                 <select
//                   value={form.bookingType}
//                   onChange={(e) => setForm((s) => ({ ...s, bookingType: e.target.value === "1" ? 1 : 0 }))}
//                   style={{ ...styles.select, ...(errors.bookingType && styles.inputError) }}
//                 >
//                   <option value="1">Accept (Approval Required)</option>
//                   <option value="0">Not Accept (Instant Booking)</option>
//                 </select>
...
//         {/* STEP 5 - Identity & Legal */}
//         {step === 5 && (
//           <section>
//             <h2 style={styles.sectionTitle}>Identity & Legal</h2>
//             <div style={styles.grid}>
              
//               <div style={{ ...styles.field, gridColumn: "1 / -1" }}>
//                 <label style={styles.label}>Identity Verification Method *</label>
//                 <div style={{ display: 'flex', gap: '20px', marginBottom: '16px' }}>
//                   <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer', gap: '8px' }}>
//                     <input 
//                       type="radio" 
...
//               {idMethod === "file" ? (
//                 <div style={{ ...styles.field, gridColumn: "1 / -1" }}>
//                   <label style={styles.label}>Government ID / Business documents *</label>
//                   <input 
//                     type="file" 
//                     accept="image/*,application/pdf" 
//                     multiple 
...
//                     Files selected: {idFiles.length}
//                   </div>
//                 </div>
//               ) : (
//                 <div style={{ ...styles.field, gridColumn: "1 / -1", background: '#f8fafc', padding: '16px', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
...
//                           style={{ 
//                             ...styles.input, 
//                             ...(errors.idFiles && styles.inputError),
//                             borderColor: aadhaarVerified ? '#22c55e' : '' 
//                           }}
//                         />
//                         {renderError("idFiles")}
//                      </div>
...
//                           borderRadius: '8px',
//                           fontWeight: '500',
//                           cursor: (aadhaarVerified || isVerifyingAadhaar || aadhaarNumber.length !== 12) ? 'default' : 'pointer',
//                           opacity: (aadhaarVerified || isVerifyingAadhaar || aadhaarNumber.length !== 12) ? 0.7 : 1
//                         }}
//                      >
//                        {isVerifyingAadhaar ? "Verifying..." : aadhaarVerified ? "Verified ✓" : "Verify Now"}
//                      </button>
//                    </div>
//                    {aadhaarVerified && (
//                      <p style={{ color: '#166534', fontSize: '13px', marginTop: '8px' }}>
//                        ✓ Aadhaar verification successful. You can proceed.
//                      </p>
//                    )}
//                 </div>
//               )}
...
//               <div style={styles.field}>
//                 <label style={styles.label}>Selfie verification (optional)</label>
//                 <input 
//                   type="file" 
//                   accept="image/*" 
...
//                 />
//                 <div style={{ color: "#64748b", fontSize: "13px", marginTop: "4px" }}>
//                   {selfieFile ? selfieFile.name : "No selfie selected"}
//                 </div>
//               </div>
...
//                   </a>
//                   {" "}for details on Flexible, Moderate, and Strict tiers.
//                 </div>
//               </div>

//               <div style={styles.field}>
//                 <label style={styles.label}>Insurance option</label>
//                 <select 
//                   value={insurance ? "yes" : "no"} 
//                   onChange={(e) => setInsurance(e.target.value === "yes")} 
//                   style={styles.select}
//                 >
//                   <option value="no">No</option>
//                   <option value="yes">Yes - include</option>
...
//               <div style={styles.field}>
//                 <label style={styles.label}>Damage protection</label>
//                 <select 
//                   value={damageProtection ? "yes" : "no"} 
//                   onChange={(e) => setDamageProtection(e.target.value === "yes")} 
//                   style={styles.select}
//                 >
//                   <option value="no">No</option>
//                   <option value="yes">Yes - require</option>

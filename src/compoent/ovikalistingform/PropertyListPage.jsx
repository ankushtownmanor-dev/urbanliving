...
// import { FiSearch, FiMapPin, FiHeart, FiFilter, FiPlus, FiStar } from 'react-icons/fi';
...
//             <p className="empty-text">We couldn't find any matches for "{searchTerm}".</p>
//             <button className="clear-search-btn" onClick={() => {setSearchTerm(''); setFilteredProperties(properties)}}>
//               Clear Search
//             </button>
//           </div>
//         )}
          ...
          <div className="empty-state-container">
            ...
            <p className="empty-text">
              {searchTerm 
                ...
                : selectedCategory
                  ? `No properties available in ${selectedCategory.title} range.`
